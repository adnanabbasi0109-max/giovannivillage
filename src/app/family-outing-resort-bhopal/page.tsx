...
export default function Page() {
  return (
    <SEOLandingPage
      ...
      introText="Giovanni Village Resort is where Bhopal families come to reconnect. Located near Kerwa Dam and surrounded by forest, the resort offers a full day's worth of activities for every age group — from a kids' zone and swimming pool to cycling trails and outdoor games. Whether you are planning a quick day outing or a weekend family vacation, Giovanni provides the space, safety, and variety that families need to truly enjoy their time together."
      features={[
        "Kids' activity zone with supervised play areas",
        "Swimming pool with dedicated children's section",
        "Family cottages with extra space and privacy",
      ...
      whyGiovanniPoints={[
        ...
        { title: "Family Cottages", text: "Our cottages are designed for families — with extra room to spread out, garden views, and easy access to the pool and kids' zone. No more cramped hotel rooms." },
        { title: "Wholesome Dining", text: "Terra restaurant serves a wide menu with options for every palate, including a kids' menu. Forest Grill offers a fun outdoor dining experience the whole family can enjoy." },
      ...
      ctaSecondary={{ label: "View Family Cottages", href: "/stay" }}
      faq={[
        ...
        { q: "Are there family meal packages?", a: "Yes, we offer family meal packages that include breakfast, lunch, and dinner with a mix of cuisines. A dedicated kids' menu is available at Terra restaurant." },
      ]}
      relatedLinks={[
        { label: "Rooms & Family Cottages", href: "/stay" },
