...
export default function WeddingVenueBhopalPage() {
  return (
    <SEOLandingPage
      ...
      introText="Surrounded by forest and adorned with natural beauty, Giovanni Village Resort is one of the most sought-after wedding destinations near Bhopal. Our venues — The Aria, Sudesh Lawns, Cocktail Lawn, and Poolside Lawn — offer versatile options for every wedding function — from mehndi and sangeet to the main ceremony and reception. With in-house catering, décor coordination, and a dedicated events team, we bring your vision to life."
      features={["Up to 5,000 guest capacity (The Aria)", "10,000 sq ft pillarless banquet hall with 50,000 sq ft lawn", "Outdoor lawns nestled between dense trees", "In-house catering with customisable menus", "Bridal suite and prep rooms", "Dedicated wedding coordinator", "Accommodation for guests on-site", "Photography-friendly venues and grounds"]}
      ...
      faq={[
        { q: "What is the maximum capacity for a wedding at Giovanni?", a: "The Aria accommodates up to 5,000 guests with a 10,000 sq ft pillarless banquet hall and 50,000 sq ft lawn. Sudesh Lawns host up to 3,000 guests." },
